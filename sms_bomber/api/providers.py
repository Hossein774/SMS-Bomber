...
class ProviderRegistry:
    ...
    def _load_default_providers(self) -> None:
        """Load the default list of providers."""
        default_providers = [
            Provider(
                name="Snapp V1",
            ...
            Provider(
                ...
                data_template={"phone": "98{phone[1:]}"},
            ),
            Provider(
                name="Zigap",
            ...
            Provider(
                ...
                data_template={
                    "credential": {"phoneNumber": "{phone}", "role": "BIKER"}
                },
            ),
            Provider(
                name="Tapsi",
                ...
                data_template={
                    "credential": {"phoneNumber": "{phone}", "role": "DRIVER"},
                    "otpOption": "SMS",
                },
            ),
            Provider(
